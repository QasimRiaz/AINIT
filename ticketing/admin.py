...
class TicketAdmin(ModelAdmin):
    ...
    fieldsets = (
        ...
        ('Automation Playbook', {
            ...
            'fields': ('inventory_host', 'auto_apply', 'ready_for_fix'),
            'description': 'This section contains the machine-readable playbook generated by the AI for automated resolution.'
        }),
        ('Metadata', {
